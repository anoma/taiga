...
use plonk::constraint_system::{StandardComposer, Variable};
...
impl<F, P, const WIDTH: usize>
    PoseidonSpec<plonk::prelude::StandardComposer<F, P>, WIDTH> for PlonkSpec<WIDTH>
where
    F: PrimeField,
    P: TEModelParameters<BaseField = F>,
{
    type Field = plonk::prelude::Variable;
    type ParameterField = F;
